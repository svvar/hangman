...
// functions :
wstring charValidation(wstring chIn, bool &ind);
wstring randomSelector(string fileName); // function that return random keyword from dictionary file
int strCompare(wstring word, wstring current);  // function that compare two strings
...
private:
	...
	wstring usedSymbols;		  // used symbols per 1 match
	wstring word;			  // keyword
	wstring currentAppearance; // word entered by user
	string man[PHASES] = { "", "\n  |\n  |\n  |\n  |\n  |\n _|__________", "\n _______\n  |     |\n  |\n  |\n  |\n  |\n _|__________",
							"\n _______\n  |     |\n  |    (_)\n  |\n  |\n  |\n _|__________", "\n _______\n  |     |\n  |    (_)\n  |    |_|\n  |\n  |\n _|__________",
							"\n _______\n  |     |\n  |    (_)\n  |   /|_|\n  |\n  |\n _|__________", "\n _______\n  |     |\n  |    (_)\n  |   /|_|\\ \n  |\n  |\n _|__________",
							"\n _______\n  |     |\n  |    (_)\n  |   /|_|\\ \n  |    /\n  |\n _|__________",
...
public:
	...
	inline wstring getWord() { return word; }		   // (where used?)
	...
	int step() { // do one step in the match, return score
		...
		if (end == false) { // if game continue
			...
			if (word.find(ch) != string::npos /*|| word.find(toupper(ch)) != string::npos*/) {
    			...
    			while(nPos != (int)string::npos){
			        currentAppearance.replace(nPos, 1, ch);					
		...
		if (word == currentAppearance) { // comparing input and keyword, if true
			end = true; // then end the game, user win
			wcout << "СЛОВО ВІДГАДАНЕ! - " << currentAppearance << endl;
			return 1;
		}

		wcout << "Використані симовли: " << usedSymbols << endl;
...
wstring charValidation(wstring chIn, bool &ind){
    ...
    wstring alphabet = L"абвгґдеєжзиіїйклмнопрстуфхцчшщьюя";
...
wstring randomSelector(string fileName) { // function that return random keyword from dictionary file
    ...
    wstring dict((std::istreambuf_iterator<char>(file)),
